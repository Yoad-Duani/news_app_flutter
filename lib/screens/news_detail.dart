...
//   Stream streamArticles = DBProvider.db.getFavoriteArticles().asStream();
//
//   @override
//   void initState() {
//     super.initState();
...
//         _favoriteArticles = snapshot.data;
//         print(_favoriteArticles);
//         // articleInCollection = checkIsSavedArticle();
//         return Scaffold(
//           body: GestureDetector(
//             onTap: () {
//               newFavoriteArticle("TRYYYYYYYYYYYYYYY");
//             },
//             child: Container(
//               color: Colors.red,
//               height: 120.0,
...
//
//   checkIsSavedArticle() {
//     // streamArticles.forEach((dynamic element) {
...
//   // Stream streamToArticles(BuildContext context) {
//   //     stream: DBProvider.db.getFavoriteArticles().asStream(),
//   //     builder: (context, snapshot) {
//   //       if (!snapshot.hasData) {
//   //         print("none");
...
///
///
/// Need to check how to use Stream with sqlite
